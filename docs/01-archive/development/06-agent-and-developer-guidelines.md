...
17. Update documentation when changing a protocol, a public API, or a security rule.
    Update verification/status.md when implementation status changes.
    Keep target architecture patterns; mark them as unimplemented rather than deleting them.
...
18. Report unresolved research questions in the PR description or as a TODO comment
    with a reference to the relevant research item in [research/README.md](../research/README.md).
